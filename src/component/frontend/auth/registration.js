...
export default function RegistrationForm1(props) {
                            ...
                            <div className='registration-header'>
                                <div class="column logocol">
                                    <div class="logo-brand">
                                        ...
                                        <div style={{fontSize:"25px"}} class="text-h6 font-weight-bold text-white">
                                            Welcome to Nagarik App
                                        </div>
